...
const ReviewerApprovalScreen = () => {
  ...
  const fetchReviewerAppraisals = async () => {
    ...
    try {
      ...
      Alert.alert('Error', 'Failed to fetch appraisals');
    } finally {
      setLoading(false);
      setRefreshing(false);
    }
  ...
  const handleSubmitToDirector = async () => {
    ...
    if (count === 0) {
      Alert.alert('Info', 'No records to submit.');
      return;
    }

    Alert.alert(
      'Submit to Director',
      `Submit ${count} record(s) to Director?`,
      [
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert('Success', `${count} record(s) submitted to Director successfully!`);
              ...
              Alert.alert('Error', 'Failed to submit to Director');
            }
          }
        }
      ]
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
              ...
              >
                ...
                <Text style={{ marginLeft: 4, color: COLORS.white, fontSize: 12 }}>Submit to Director</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
            ...
            <ScrollView horizontal>
              <View>
                ...
                <View style={{ flexDirection: 'row', backgroundColor: COLORS.primary, paddingVertical: 12, paddingHorizontal: 4 }}>
                  ...
                  <Text style={{ width: 120, color: COLORS.white, fontWeight: '600', fontSize: 12, textAlign: 'center' }}>Reviewer Comments</Text>
                        ...
                        {isEditing ? (
                          ...
                          <TouchableOpacity onPress={() => openCommentModal(emp)}>
                            <Text style={{ fontSize: 10, color: COLORS.blue, textAlign: 'center' }} numberOfLines={2}>
                              {emp.reviewerComments || <Text style={{ color: COLORS.gray, fontStyle: 'italic' }}>Add comments...</Text>}
                            </Text>
                          </TouchableOpacity>
                        )}
                      </View>
        ...
        <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', alignItems: 'center' }}>
          <View style={{ backgroundColor: COLORS.white, borderRadius: 12, width: '90%', maxWidth: 400, padding: 20 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
              <Text style={{ fontSize: 18, fontWeight: '600', color: COLORS.textPrimary }}>Reviewer Comments</Text>
              ...
              <ScrollView style={{ padding: 16 }}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 20 }}>
                  ...
                  <View style={{ marginLeft: 12 }}>
                    ...
                    <Text style={{ fontSize: 11, color: COLORS.gray }}>{viewModalData.empId}</Text>
                  </View>
                </View>

                {/* Self Appraisal */}
                <View style={{ backgroundColor: COLORS.blueLight, borderRadius: 8, padding: 12, marginBottom: 12 }}>
                  <Text style={{ fontSize: 12, fontWeight: '600', color: COLORS.primary, marginBottom: 4 }}>Self Appraisal</Text>
                ...
                {/* Manager Review */}
                <View style={{ backgroundColor: COLORS.indigoLight, borderRadius: 8, padding: 12, marginBottom: 12 }}>
                  <Text style={{ fontSize: 12, fontWeight: '600', color: COLORS.indigo, marginBottom: 4 }}>Manager Review</Text>
                  <Text style={{ fontSize: 12, color: COLORS.textPrimary, fontStyle: 'italic' }}>
